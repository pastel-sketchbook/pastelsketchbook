...
| 14 | Custom Graphs in Microsoft Sentinel (Preview) | 65 | Apr 11, 2026 | [Watch](https://youtu.be/u8XCBK6lGw0) | [Wiki](details/u8XCBK6lGw0.md) |
| 15 | Black-Hat LLMs: The End of the 20-Year Security Balance | 84 | Mar 31, 2026 | [Watch](https://youtu.be/Zeg8zSOvoyE) | [Wiki](details/Zeg8zSOvoyE.md) |
| 16 | 2FA Orchestration in PingFederate | 11 | Mar 29, 2026 | [Watch](https://youtu.be/HxB-cJIbEgE) | [Wiki](details/HxB-cJIbEgE.md) |
| 17 | Anatomy of a Supply Chain Attack | 38 | Mar 26, 2026 | [Watch](https://youtu.be/taBP0Fr3uSQ) | [Wiki](details/taBP0Fr3uSQ.md) |
| 18 | Containing the Untrusted Agent | 34 | Mar 25, 2026 | [Watch](https://youtu.be/CA1nlknmR3g) | [Wiki](details/CA1nlknmR3g.md) |
| 19 | The NIST Cybersecurity Framework 2.0 | 26 | Mar 8, 2026 | [Watch](https://youtu.be/1VjSLqfPf9s) | [Wiki](details/1VjSLqfPf9s.md) |
...
`security` (3) . `idp` (2) . `zero trust` (2) . `agent` (2) . `sentinel` (2) . `siem` (2) . `soar` (2) . `xdr` (2) . `llm` (2) . `nist` (2) . `rust` (1) . `sca` (1) . `tracking` (1) . `observability` (1) . `passwordless` (1) . `curiosity` (1) . `cryptography` (1) . `yubikey` (1) . `secretive` (1) . `ssh-tpm-agent` (1)

## See Also

- [Kubernetes](kubernetes.md) -- shared tags: `curiosity`, `ai`, `rust`, `idp`, `agent`, `resilience`, `zero trust`, `observability`, `shift left`, `aws`, `azure`, `secret`, `orchestration`, `governance`, `security`
- [Development](development.md) -- shared tags: `curiosity`, `ai`, `rust`, `idp`, `agent`, `resilience`, `zero trust`, `observability`, `shift left`, `llm`, `data`, `service`, `context`, `algorithms`, `toolkit`, `token`, `ssrf`
