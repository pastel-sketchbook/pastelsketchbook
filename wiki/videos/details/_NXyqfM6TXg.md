...
- [Custom Graphs in Microsoft Sentinel (Preview)](https://youtu.be/u8XCBK6lGw0) — Security · 54 views · Apr 11, 2026 · [Details](u8XCBK6lGw0.md) (shared: `sentinel` · `microsoft` · `security`)
- [Azure Enterprise Edge Lab](https://youtu.be/fMjflPvjaJ8) — Kubernetes · 8 views · Mar 31, 2026 · [Details](fMjflPvjaJ8.md) (shared: `azure` · `sentinel` · `microsoft`)
