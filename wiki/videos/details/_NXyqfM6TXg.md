...
- [Custom Graphs in Microsoft Sentinel (Preview)](https://youtu.be/u8XCBK6lGw0) — Security · 58 views · Apr 11, 2026 · [Details](u8XCBK6lGw0.md) (shared: `sentinel` · `microsoft` · `security`)
