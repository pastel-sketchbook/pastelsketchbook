...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 847 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `pattern` · `repository pattern` · `repository`)
- [Modern State Architecture: The Repository Pattern](https://youtu.be/3ybGkjogcFQ) — Development · 42 views · Feb 20, 2026 · [Details](3ybGkjogcFQ.md) (shared: `pattern` · `repository pattern` · `repository`)
...
- [The Architecture of Systemic Decoupling](https://youtu.be/R3n8UxyD7mc) — Development · 56 views · Apr 27, 2026 · [Details](R3n8UxyD7mc.md) (shared: `pattern` · `repository pattern` · `repository`)
