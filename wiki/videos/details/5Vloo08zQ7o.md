...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 811 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `pattern` · `repository pattern` · `repository`)
