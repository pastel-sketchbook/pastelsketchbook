...
- [The Axum Web Framework](https://youtu.be/J4iGUAXcAOA) — Development · 84 views · May 1, 2026 · [Details](J4iGUAXcAOA.md) (shared: `web` · `framework` · `middleware`)
...
- [The Burn Book](https://youtu.be/B7MMdnv3y1M) — Development · 34 views · May 21, 2026 · [Details](B7MMdnv3y1M.md) (shared: `framework` · `pipeline` · `architecture`)
