...
- [Let's check about Zig](https://youtu.be/olsB3bJxA2A) — Development · 351 views · Dec 28, 2025 · [Details](olsB3bJxA2A.md) (shared: `garbage` · `collection` · `memory`)
...
- [OpenCV Library Architecture and Capabilities](https://youtu.be/ZfAc2pqcS-4) — Development · 59 views · May 11, 2026 · [Details](ZfAc2pqcS-4.md) (shared: `hardware` · `simd` · `pipeline`)
