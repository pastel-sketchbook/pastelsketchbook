...
- [The End of the Functional Programming Tax](https://youtu.be/240fOdSvnpk) — Development · 53 views · Jun 14, 2026 · [Details](240fOdSvnpk.md) (shared: `garbage` · `collection` · `memory`)
...
- [High-Performance Compute Meets Developer Ergonomics](https://youtu.be/Z_TABCzmoQ0) — Development · 45 views · Jun 15, 2026 · [Details](Z_TABCzmoQ0.md) (shared: `memory` · `vectorization` · `simd`)
