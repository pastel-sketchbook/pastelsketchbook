...
- [Black-Hat LLMs: The End of the 20-Year Security Balance](https://youtu.be/Zeg8zSOvoyE) — Security · 82 views · Mar 31, 2026 · [Details](Zeg8zSOvoyE.md) (shared: `autonomous` · `security` · `exploitation`)
...
- [Unified Passwordless Identity](https://youtu.be/LGKBWq8g1u4) — Security · 11 views · Aug 16, 2026 · [Details](LGKBWq8g1u4.md) (shared: `agent` · `proof`)
