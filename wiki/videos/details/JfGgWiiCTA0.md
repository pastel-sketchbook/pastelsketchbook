...
- [ZAP: Getting Started with Software Security Testing](https://youtu.be/infh5ZZwvLU) — Security · 17 views · Apr 30, 2026 · [Details](infh5ZZwvLU.md) (shared: `penetration` · `testing` · `security`)
- [Black-Hat LLMs: The End of the 20-Year Security Balance](https://youtu.be/Zeg8zSOvoyE) — Security · 75 views · Mar 31, 2026 · [Details](Zeg8zSOvoyE.md) (shared: `autonomous` · `security` · `exploitation`)
