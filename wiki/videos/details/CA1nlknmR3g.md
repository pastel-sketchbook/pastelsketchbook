...
- [ZAP: Getting Started with Software Security Testing](https://youtu.be/infh5ZZwvLU) — Security · 23 views · Apr 30, 2026 · [Details](infh5ZZwvLU.md) (shared: `defense in depth` · `defense` · `depth`)
...
- [Microsoft Agent Governance Toolkit](https://youtu.be/MFiVlaMYmwM) — Security · 60 views · May 22, 2026 · [Details](MFiVlaMYmwM.md) (shared: `agent` · `security`)
