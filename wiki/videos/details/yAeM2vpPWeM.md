...
- [Backend Patterns in Rust](https://youtu.be/Th5MMOFQbh8) — Development · 50 views · Feb 22, 2026 · [Details](Th5MMOFQbh8.md) (shared: `dependency` · `event-driven architecture` · `event-driven`)
