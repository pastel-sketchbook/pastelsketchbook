...
- [Backend Patterns in Rust](https://youtu.be/Th5MMOFQbh8) — Development · 48 views · Feb 22, 2026 · [Details](Th5MMOFQbh8.md) (shared: `dependency` · `event-driven architecture` · `event-driven`)
...
- [The Push Architecture Blueprint](https://youtu.be/oqi_jJl3tAQ) — Development · 46 views · Apr 30, 2026 · [Details](oqi_jJl3tAQ.md) (shared: `event-driven architecture` · `event-driven` · `architecture`)
