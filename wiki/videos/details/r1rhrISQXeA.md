...
- [SlideVoice Studio Desktop Shell Architecture](https://youtu.be/ytA6gw6Tgaw) — Development · 33 views · May 17, 2026 · [Details](ytA6gw6Tgaw.md) (shared: `gemini api narration` · `gemini` · `api`)
...
- [Velox: Bring Tauri to Swift](https://youtu.be/Ul0ixBpd5iM) — Development · 50 views · Jan 27, 2026 · [Details](Ul0ixBpd5iM.md) (shared: `swift` · `native` · `development`)
