...
- [Velox: Bring Tauri to Swift](https://youtu.be/Ul0ixBpd5iM) — Development · 47 views · Jan 27, 2026 · [Details](Ul0ixBpd5iM.md) (shared: `swift` · `native` · `development`)
- [svs-cli: 10 Critical Things](https://youtu.be/S3Vc_R-HezY) — Development · 16 views · May 24, 2026 · [Details](S3Vc_R-HezY.md) (shared: `gemini` · `api` · `ffmpeg`)
- [AI Agents  Idea to Tool](https://youtu.be/tqDisu2tmG0) — Development · 6 views · Jan 10, 2026 · [Details](tqDisu2tmG0.md) (shared: `development` · `automation`)
