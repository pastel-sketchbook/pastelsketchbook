...
- [Agentic Platform Engineering with GitHub Copilot](https://youtu.be/lexZnOlyml0) — Kubernetes · 75 views · Mar 26, 2026 · [Details](lexZnOlyml0.md) (shared: `automation`)
...
- [Mastering Batch Workload Orchestration on Kubernetes](https://youtu.be/XKTtea0xGsA) — Kubernetes · 27 views · Jul 17, 2026 · [Details](XKTtea0xGsA.md) (shared: `budgets`)
