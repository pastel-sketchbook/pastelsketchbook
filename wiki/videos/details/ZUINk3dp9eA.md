...
- [Modern State Architecture: The Repository Pattern](https://youtu.be/3ybGkjogcFQ) — Development · 42 views · Feb 20, 2026 · [Details](3ybGkjogcFQ.md) (shared: `architecture` · `query` · `pattern`)
- [Bulletproof Frontend Architecture](https://youtu.be/5Vloo08zQ7o) — Development · 33 views · Feb 16, 2026 · [Details](5Vloo08zQ7o.md) (shared: `architecture` · `adapter` · `pattern`)
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 847 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `architecture` · `pattern` · `testing`)
