...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 819 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `dependency` · `architecture` · `dependency injection`)
