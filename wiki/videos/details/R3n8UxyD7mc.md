...
- [Clean Architecture in Angular](https://youtu.be/RJGNh8L-8rw) — Development · 49 views · Jun 23, 2026 · [Details](RJGNh8L-8rw.md) (shared: `dependency inversion principle` · `dependency` · `inversion`)
