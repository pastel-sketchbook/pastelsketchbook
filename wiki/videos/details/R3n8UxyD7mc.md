...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 784 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `dependency` · `architecture` · `dependency injection`)
...
- [Architecting Scalable Rust Backends](https://youtu.be/SpNfrWmI8iE) — Development · 66 views · Feb 22, 2026 · [Details](SpNfrWmI8iE.md) (shared: `dependency` · `architecture` · `dependency injection`)
