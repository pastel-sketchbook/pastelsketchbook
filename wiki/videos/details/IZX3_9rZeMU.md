...
- [Let's check about Zig](https://youtu.be/olsB3bJxA2A) — Development · 358 views · Dec 28, 2025 · [Details](olsB3bJxA2A.md) (shared: `programming` · `memory management` · `memory`)
- [Zig  Pragmatic Successor to C](https://youtu.be/yOOQNnaOLeM) — Development · 27 views · Jan 9, 2026 · [Details](yOOQNnaOLeM.md) (shared: `programming` · `memory management` · `memory`)
