...
- [Let's check about Zig](https://youtu.be/olsB3bJxA2A) — Development · 350 views · Dec 28, 2025 · [Details](olsB3bJxA2A.md) (shared: `programming` · `memory management` · `memory`)
...
- [The Memory Management Trilemma](https://youtu.be/axvxGj3yOgA) — Development · 34 views · Jan 6, 2026 · [Details](axvxGj3yOgA.md) (shared: `programming` · `memory management` · `memory`)
