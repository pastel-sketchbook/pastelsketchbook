...
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 66 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `zig` · `struct of arrays` · `struct`)
