...
- [microgpt-zig: Atomic Al Training](https://youtu.be/AcpVuvtSXwI) — Development · 54 views · Feb 28, 2026 · [Details](AcpVuvtSXwI.md) (shared: `zig` · `zero-dependency`)
...
- [Inside the Typst Compiler Engine](https://youtu.be/B81dHVYOYJA) — Development · 69 views · May 10, 2026 · [Details](B81dHVYOYJA.md) (shared: `pipeline` · `layout` · `svg`)
...
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 70 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `layout` · `zig`)
