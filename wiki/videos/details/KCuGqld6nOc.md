...
- [Architectural Principles of Fearless Concurrency](https://youtu.be/F59lTcC6xJ0) — Development · 52 views · Mar 28, 2026 · [Details](F59lTcC6xJ0.md) (shared: `concurrency` · `data`)
- [The End of the Functional Programming Tax](https://youtu.be/240fOdSvnpk) — Development · 76 views · Jun 14, 2026 · [Details](240fOdSvnpk.md) (shared: `concurrency` · `data`)
