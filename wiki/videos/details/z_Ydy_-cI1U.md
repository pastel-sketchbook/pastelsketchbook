...
- [The Strangler Fig Pattern](https://youtu.be/4aAyFYemYD8) — Development · 43 views · Apr 28, 2026 · [Details](4aAyFYemYD8.md) (shared: `monolith decomposition` · `monolith` · `decomposition`)
...
- [RFC 862 and the Echo Protocol](https://youtu.be/ea5lpF3RyzE) — Development · 39 views · Apr 7, 2026 · [Details](ea5lpF3RyzE.md) (shared: `distributed` · `systems`)
