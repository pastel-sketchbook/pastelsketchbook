...
- [The Strangler Fig Pattern](https://youtu.be/4aAyFYemYD8) — Development · 98 views · Apr 28, 2026 · [Details](4aAyFYemYD8.md) (shared: `monolith decomposition` · `monolith` · `decomposition`)
...
- [Resilient Asynchronous Systems in Go](https://youtu.be/INNKxTAagE4) — Development · 40 views · Mar 23, 2026 · [Details](INNKxTAagE4.md) (shared: `distributed` · `systems`)
- [RFC 862 and the Echo Protocol](https://youtu.be/ea5lpF3RyzE) — Development · 42 views · Apr 7, 2026 · [Details](ea5lpF3RyzE.md) (shared: `distributed` · `systems`)
