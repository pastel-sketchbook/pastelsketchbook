...
- [Mastering Machine Learning in Rust](https://youtu.be/htpvlYnX77w) — Development · 47 views · May 19, 2026 · [Details](htpvlYnX77w.md) (shared: `burn framework` · `burn` · `framework`)
- [Burn: The Rust Deep Learning Framework](https://youtu.be/joYJ6rPN3UI) — Development · 570 views · Feb 13, 2026 · [Details](joYJ6rPN3UI.md) (shared: `deep` · `learning` · `architecture`)
- [The Anatomy of a Modern Robot](https://youtu.be/7ygjuzLkdTE) — Development · 20 views · Jun 24, 2026 · [Details](7ygjuzLkdTE.md) (shared: `architecture` · `vision` · `models`)
