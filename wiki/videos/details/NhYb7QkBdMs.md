...
- [Mastering Serde in Rust ](https://youtu.be/RDa6WtZmW8E) — Development · 46 views · Jan 28, 2026 · [Details](RDa6WtZmW8E.md) (shared: `serde` · `serialization` · `rust`)
...
- [Composition by Design](https://youtu.be/ARWkoc3E8uE) — Development · 31 views · Feb 23, 2026 · [Details](ARWkoc3E8uE.md) (shared: `rust` · `design`)
