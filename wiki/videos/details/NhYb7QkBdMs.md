...
- [Mastering Serde in Rust ](https://youtu.be/RDa6WtZmW8E) — Development · 68 views · Jan 28, 2026 · [Details](RDa6WtZmW8E.md) (shared: `serde` · `serialization` · `rust`)
...
- [The Rust Architect's Sketchbook](https://youtu.be/7zFqW-ZcEbo) — Development · 94 views · Jan 8, 2026 · [Details](7zFqW-ZcEbo.md) (shared: `serde serialization` · `serde` · `serialization`)
