...
- [The Burn Book App Architecture](https://youtu.be/TpyKC8_30xs) — Development · 5 views · May 23, 2026 · [Details](TpyKC8_30xs.md) (shared: `tauri 2 desktop shell` · `tauri` · `desktop`)
...
- [Modern State Architecture: The Repository Pattern](https://youtu.be/3ybGkjogcFQ) — Development · 35 views · Feb 20, 2026 · [Details](3ybGkjogcFQ.md) (shared: `architecture` · `react`)
- [rr-mailtrap: The Developer's SMTP Sandbox](https://youtu.be/SuuZW_fuEFc) — Development · 24 views · May 8, 2026 · [Details](SuuZW_fuEFc.md) (shared: `import` · `export` · `content`)
