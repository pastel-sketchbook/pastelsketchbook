...
- [The Burn Book App Architecture](https://youtu.be/TpyKC8_30xs) — Development · 14 views · May 23, 2026 · [Details](TpyKC8_30xs.md) (shared: `tauri 2 desktop shell` · `tauri` · `desktop`)
...
- [svs-cli: 10 Critical Things](https://youtu.be/S3Vc_R-HezY) — Development · 11 views · May 24, 2026 · [Details](S3Vc_R-HezY.md) (shared: `gemini` · `api` · `slide`)
