...
- [The Burn Book App Architecture](https://youtu.be/TpyKC8_30xs) — Development · 20 views · May 23, 2026 · [Details](TpyKC8_30xs.md) (shared: `tauri 2 desktop shell` · `tauri` · `desktop`)
...
- [Velox: Bring Tauri to Swift](https://youtu.be/Ul0ixBpd5iM) — Development · 50 views · Jan 27, 2026 · [Details](Ul0ixBpd5iM.md) (shared: `tauri` · `desktop` · `architecture`)
