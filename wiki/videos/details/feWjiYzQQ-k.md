...
- [Rust 1.95.0](https://youtu.be/izLrX-02IQk) — Development · 269 views · Apr 18, 2026 · [Details](izLrX-02IQk.md) (shared: `rust` · `crate`)
- [Blueprinting Machine Learning in Rust](https://youtu.be/KR188eZ9gRE) — Development · 35 views · May 20, 2026 · [Details](KR188eZ9gRE.md) (shared: `rust` · `crate`)
