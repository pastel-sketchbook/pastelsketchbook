...
- [Architecting the Next Evolution of the Local Database](https://youtu.be/EWwk29GzHgg) — Development · 117 views · Apr 27, 2026 · [Details](EWwk29GzHgg.md) (shared: `vector search` · `vector` · `search`)
