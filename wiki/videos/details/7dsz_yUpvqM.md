...
- [The 25519 Cryptographic Family](https://youtu.be/MzdV5hjPdsI) — Security · 32 views · Jun 28, 2026 · [Details](MzdV5hjPdsI.md) (shared: `time` · `key` · `exchange`)
- [Shannon: Autonomous Penetration Testing](https://youtu.be/JfGgWiiCTA0) — Security · 70 views · Feb 14, 2026 · [Details](JfGgWiiCTA0.md) (shared: `security` · `proof`)
