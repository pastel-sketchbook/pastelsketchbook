...
- [The 25519 Cryptographic Family](https://youtu.be/MzdV5hjPdsI) — Security · 26 views · Jun 28, 2026 · [Details](MzdV5hjPdsI.md) (shared: `time` · `key` · `exchange`)
- [Shannon: Autonomous Penetration Testing](https://youtu.be/JfGgWiiCTA0) — Security · 63 views · Feb 14, 2026 · [Details](JfGgWiiCTA0.md) (shared: `security` · `proof`)
- [The Strategic Roadmap for Data Classification](https://youtu.be/uhXcsWYhdkA) — Security · 24 views · Mar 2, 2026 · [Details](uhXcsWYhdkA.md) (shared: `security` · `zero`)
