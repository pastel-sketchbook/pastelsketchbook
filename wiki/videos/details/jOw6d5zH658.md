...
- [The Complete Guide to Building Skills for Claude](https://youtu.be/JeqaHMmSh1s) — Development · 711 views · Feb 27, 2026 · [Details](JeqaHMmSh1s.md) (shared: `yaml` · `model` · `token`)
...
- [Mastering Serde in Rust ](https://youtu.be/RDa6WtZmW8E) — Development · 52 views · Jan 28, 2026 · [Details](RDa6WtZmW8E.md) (shared: `yaml` · `model`)
