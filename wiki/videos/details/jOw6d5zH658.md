...
- [The Complete Guide to Building Skills for Claude](https://youtu.be/JeqaHMmSh1s) — Development · 730 views · Feb 27, 2026 · [Details](JeqaHMmSh1s.md) (shared: `yaml` · `model` · `token`)
...
- [The Open Market of Al Coding](https://youtu.be/T-NdEF6btbg) — Development · 97 views · Apr 5, 2026 · [Details](T-NdEF6btbg.md) (shared: `agent` · `model` · `token`)
- [Mastering Serde in Rust ](https://youtu.be/RDa6WtZmW8E) — Development · 75 views · Jan 28, 2026 · [Details](RDa6WtZmW8E.md) (shared: `yaml` · `model`)
