...
- [Architecting Scalable Rust Backends](https://youtu.be/SpNfrWmI8iE) — Development · 69 views · Feb 22, 2026 · [Details](SpNfrWmI8iE.md) (shared: `rust` · `backend` · `architecture`)
...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 788 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `architecture` · `pattern` · `dependency injection`)
