...
- [Architecting Scalable Rust Backends](https://youtu.be/SpNfrWmI8iE) — Development · 81 views · Feb 22, 2026 · [Details](SpNfrWmI8iE.md) (shared: `rust` · `backend` · `architecture`)
...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 841 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `architecture` · `pattern` · `dependency injection`)
- [The Compensating Transaction Pattern](https://youtu.be/xlwu0YwE3_Q) — Development · 20 views · Apr 30, 2026 · [Details](xlwu0YwE3_Q.md) (shared: `architecture` · `saga pattern` · `saga`)
