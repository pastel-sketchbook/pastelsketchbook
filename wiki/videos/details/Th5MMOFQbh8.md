...
- [The Architecture of Systemic Decoupling](https://youtu.be/R3n8UxyD7mc) — Development · 54 views · Apr 27, 2026 · [Details](R3n8UxyD7mc.md) (shared: `architecture` · `pattern` · `dependency injection`)
- [Tokio: The Asynchronous Runtime for Rust](https://youtu.be/0Sed1oggMKY) — Development · 87 views · Feb 8, 2026 · [Details](0Sed1oggMKY.md) (shared: `rust` · `architecture` · `event-driven architecture`)
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 785 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `architecture` · `pattern` · `dependency injection`)
- [The Compensating Transaction Pattern](https://youtu.be/xlwu0YwE3_Q) — Development · 13 views · Apr 30, 2026 · [Details](xlwu0YwE3_Q.md) (shared: `architecture` · `saga pattern` · `saga`)
