...
- [The Transport Revolution: Deconstructing HTTP/3](https://youtu.be/JWeu5aqAkR0) — Development · 209 views · Apr 1, 2026 · [Details](JWeu5aqAkR0.md) (shared: `http` · `quic` · `tcp`)
...
- [Introducing ExtendDB](https://youtu.be/LxI5YjCUswI) — Kubernetes · 20 views · May 24, 2026 · [Details](LxI5YjCUswI.md) (shared: `protocol` · `edge` · `architecture`)
