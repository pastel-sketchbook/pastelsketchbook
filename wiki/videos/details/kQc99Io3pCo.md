...
- [Mastering Serde in Rust ](https://youtu.be/RDa6WtZmW8E) — Development · 47 views · Jan 28, 2026 · [Details](RDa6WtZmW8E.md) (shared: `rust` · `data`)
...
- [Serverless Analytics with DuckDB & Python](https://youtu.be/ZBW6YozOu78) — Development · 42 views · Mar 14, 2026 · [Details](ZBW6YozOu78.md) (shared: `data` · `infrastructure`)
