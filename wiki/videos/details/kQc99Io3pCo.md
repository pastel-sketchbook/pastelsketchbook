...
- [Mastering Serde in Rust ](https://youtu.be/RDa6WtZmW8E) — Development · 68 views · Jan 28, 2026 · [Details](RDa6WtZmW8E.md) (shared: `rust` · `data`)
- [Architectural Principles of Fearless Concurrency](https://youtu.be/F59lTcC6xJ0) — Development · 52 views · Mar 28, 2026 · [Details](F59lTcC6xJ0.md) (shared: `rust` · `data`)
- [Serverless Analytics with DuckDB & Python](https://youtu.be/ZBW6YozOu78) — Development · 84 views · Mar 14, 2026 · [Details](ZBW6YozOu78.md) (shared: `data` · `infrastructure`)
