...
- [Mastering Serde in Rust ](https://youtu.be/RDa6WtZmW8E) — Development · 58 views · Jan 28, 2026 · [Details](RDa6WtZmW8E.md) (shared: `serde` · `data` · `model`)
- [The Universal Engine for LLM Inference](https://youtu.be/OKXt-PJUuzE) — Development · 91 views · Jun 21, 2026 · [Details](OKXt-PJUuzE.md) (shared: `model` · `strategies` · `format`)
