...
- [Mastering Serde in Rust ](https://youtu.be/RDa6WtZmW8E) — Development · 71 views · Jan 28, 2026 · [Details](RDa6WtZmW8E.md) (shared: `serde` · `data` · `model`)
- [The Universal Engine for LLM Inference](https://youtu.be/OKXt-PJUuzE) — Development · 98 views · Jun 21, 2026 · [Details](OKXt-PJUuzE.md) (shared: `model` · `strategies` · `format`)
...
- [Bulletproof Frontend Architecture](https://youtu.be/5Vloo08zQ7o) — Development · 34 views · Feb 16, 2026 · [Details](5Vloo08zQ7o.md) (shared: `pattern` · `data`)
