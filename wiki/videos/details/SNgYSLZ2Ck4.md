...
- [Mastering Serde in Rust ](https://youtu.be/RDa6WtZmW8E) — Development · 84 views · Jan 28, 2026 · [Details](RDa6WtZmW8E.md) (shared: `serde` · `data` · `model`)
...
- [Bulletproof Frontend Architecture](https://youtu.be/5Vloo08zQ7o) — Development · 35 views · Feb 16, 2026 · [Details](5Vloo08zQ7o.md) (shared: `pattern` · `data`)
