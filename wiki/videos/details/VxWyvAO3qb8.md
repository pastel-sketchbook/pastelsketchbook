...
- [Secure Web App with Azure AD/OAuth2 Proxy](https://youtu.be/rgY4KTMFOMs) — Kubernetes · 82 views · Feb 5, 2026 · [Details](rgY4KTMFOMs.md) (shared: `azure` · `aks` · `architecture`)
...
- [K8s Services  AKS & Istio](https://youtu.be/C5HqbzLRYZ0) — Kubernetes · 32 views · Jan 10, 2026 · [Details](C5HqbzLRYZ0.md) (shared: `aks` · `traffic`)
