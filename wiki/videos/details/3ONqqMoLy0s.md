...
- [Neural TTS in Pastel-HN](https://youtu.be/d_0swhS1LyQ) — Development · 47 views · Feb 1, 2026 · [Details](d_0swhS1LyQ.md) (shared: `neural` · `synthesis`)
...
- [Cross-Runtime Development with Rust and napi-rs](https://youtu.be/97zSu6wYF5w) — Development · 73 views · Jul 10, 2026 · [Details](97zSu6wYF5w.md) (shared: `hybrid` · `pipeline`)
