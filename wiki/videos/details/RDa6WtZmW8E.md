...
- [Rusty Object Notation (RON)](https://youtu.be/NhYb7QkBdMs) — Development · 176 views · Apr 24, 2026 · [Details](NhYb7QkBdMs.md) (shared: `serde` · `rust` · `serialization`)
- [The Rust Architect's Sketchbook](https://youtu.be/7zFqW-ZcEbo) — Development · 94 views · Jan 8, 2026 · [Details](7zFqW-ZcEbo.md) (shared: `serde` · `serialization` · `data`)
