...
- [Bevy-Demo](https://youtu.be/_zJ3_d1CODg) — Development · 136 views · Mar 18, 2026 · [Details](_zJ3_d1CODg.md) (shared: `bevy` · `engine` · `rust`)
...
- [Diagnostic Guide to Computer Vision Feature Detection](https://youtu.be/AvysIjFrTEw) — Development · 22 views · May 11, 2026 · [Details](AvysIjFrTEw.md) (shared: `real-time` · `detection`)
- [Candle: A Minimalist Framework for Serverless ML Inference](https://youtu.be/8PaVKQoDReY) — Development · 33 views · May 9, 2026 · [Details](8PaVKQoDReY.md) (shared: `engine` · `rust`)
