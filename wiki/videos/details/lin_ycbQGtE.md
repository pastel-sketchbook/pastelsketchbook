...
- [Bevy-Demo](https://youtu.be/_zJ3_d1CODg) — Development · 145 views · Mar 18, 2026 · [Details](_zJ3_d1CODg.md) (shared: `bevy` · `engine` · `rust`)
...
- [Candle: A Minimalist Framework for Serverless ML Inference](https://youtu.be/8PaVKQoDReY) — Development · 59 views · May 9, 2026 · [Details](8PaVKQoDReY.md) (shared: `engine` · `rust`)
