...
- [K8s Services  AKS & Istio](https://youtu.be/C5HqbzLRYZ0) — Kubernetes · 46 views · Jan 10, 2026 · [Details](C5HqbzLRYZ0.md) (shared: `istio service mesh` · `istio` · `service`)
...
- [Secure Web App with Azure AD/OAuth2 Proxy](https://youtu.be/rgY4KTMFOMs) — Kubernetes · 86 views · Feb 5, 2026 · [Details](rgY4KTMFOMs.md) (shared: `istio service mesh` · `istio` · `service`)
