...
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 119 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `zig` · `performance` · `data-oriented design`)
- [Memory Layout in Zig](https://youtu.be/h31-NtagNoU) — Development · 63 views · Jan 29, 2026 · [Details](h31-NtagNoU.md) (shared: `zig` · `data-oriented design` · `data-oriented`)
