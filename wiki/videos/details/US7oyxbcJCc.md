...
- [Cloth Simulation ](https://youtu.be/3Fpey_L_XRU) — Development · 14 views · Jan 25, 2026 · [Details](3Fpey_L_XRU.md) (shared: `cloth simulation` · `cloth` · `simulation`)
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 85 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `zig` · `performance` · `data-oriented design`)
...
- [Velox: Bring Tauri to Swift](https://youtu.be/Ul0ixBpd5iM) — Development · 48 views · Jan 27, 2026 · [Details](Ul0ixBpd5iM.md) (shared: `native` · `swift` · `layer`)
