...
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 73 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `zig` · `performance` · `data-oriented design`)
...
- [Velox: Bring Tauri to Swift](https://youtu.be/Ul0ixBpd5iM) — Development · 47 views · Jan 27, 2026 · [Details](Ul0ixBpd5iM.md) (shared: `native` · `swift` · `layer`)
