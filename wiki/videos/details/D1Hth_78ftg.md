...
- [타입스크립트와 번으로 배우는 프로그래밍 1](https://youtu.be/T5FjMjTQCBI) — Programming · 81 views · Jan 10, 2026 · [Details](T5FjMjTQCBI.md) (shared: `bun runtime` · `bun` · `runtime`)
- [알고리즘에서 코드로  TypeScript 가이드](https://youtu.be/dsxuWtfzBGI) — Programming · 14 views · Jan 14, 2026 · [Details](dsxuWtfzBGI.md) (shared: `typescript` · `korean programming tutorial` · `korean`)
...
- [영어 리스닝  3000시간의 법칙](https://youtu.be/qyqLjeu8Hng) — Programming · 65 views · Jan 13, 2026 · [Details](qyqLjeu8Hng.md) (shared: `korean`)
