...
- [zig-twitter: Anatomy of a Hybrid Terminal Client](https://youtu.be/a2kADxV0kBM) — Development · 38 views · Mar 14, 2026 · [Details](a2kADxV0kBM.md) (shared: `api` · `design`)
...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 844 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `api` · `design`)
- [The Evolution of File Detection](https://youtu.be/85pyYZFJ6_s) — Development · 48 views · May 7, 2026 · [Details](85pyYZFJ6_s.md) (shared: `google` · `security`)
