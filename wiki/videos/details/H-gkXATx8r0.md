...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 785 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `api` · `design`)
- [Stitch Agent Skills](https://youtu.be/fv61JXUCbeo) — Development · 273 views · Apr 5, 2026 · [Details](fv61JXUCbeo.md) (shared: `google` · `design`)
