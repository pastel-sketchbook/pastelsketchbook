...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 789 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `api` · `design`)
- [The Evolution of File Detection](https://youtu.be/85pyYZFJ6_s) — Development · 32 views · May 7, 2026 · [Details](85pyYZFJ6_s.md) (shared: `google` · `security`)
