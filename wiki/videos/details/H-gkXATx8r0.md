...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 784 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `api` · `design`)
- [Stitch Agent Skills](https://youtu.be/fv61JXUCbeo) — Development · 272 views · Apr 5, 2026 · [Details](fv61JXUCbeo.md) (shared: `google` · `design`)
