...
- [Modern State Architecture: The Repository Pattern](https://youtu.be/3ybGkjogcFQ) — Development · 39 views · Feb 20, 2026 · [Details](3ybGkjogcFQ.md) (shared: `architecture` · `state` · `management`)
- [Clean Architecture in Angular](https://youtu.be/RJGNh8L-8rw) — Development · 54 views · Jun 23, 2026 · [Details](RJGNh8L-8rw.md) (shared: `riverpod` · `architecture` · `state`)
...
- [Architecting Scalable Rust Backends](https://youtu.be/SpNfrWmI8iE) — Development · 81 views · Feb 22, 2026 · [Details](SpNfrWmI8iE.md) (shared: `architecture` · `async` · `dependency`)
