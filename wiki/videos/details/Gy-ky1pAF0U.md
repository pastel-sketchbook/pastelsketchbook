...
- [Modern State Architecture: The Repository Pattern](https://youtu.be/3ybGkjogcFQ) — Development · 35 views · Feb 20, 2026 · [Details](3ybGkjogcFQ.md) (shared: `architecture` · `state` · `management`)
...
- [Architecting Network Layers with Dio](https://youtu.be/BhzeYd4aqOQ) — Development · 15 views · May 16, 2026 · [Details](BhzeYd4aqOQ.md) (shared: `architecture` · `taxonomy` · `flutter`)
