...
- [Securely Exposing AKS Applications](https://youtu.be/A7eoKD5m6Ek) — Kubernetes · 10 views · Jan 8, 2026 · [Details](A7eoKD5m6Ek.md) (shared: `aks` · `cluster`)
- [Kubernetes Version Upgrade Strategy](https://youtu.be/ftODZr2_V5Q) — Kubernetes · 32 views · Dec 26, 2025 · [Details](ftODZr2_V5Q.md) (shared: `aks` · `cluster`)
...
- [K8s Services  AKS & Istio](https://youtu.be/C5HqbzLRYZ0) — Kubernetes · 46 views · Jan 10, 2026 · [Details](C5HqbzLRYZ0.md) (shared: `aks`)
