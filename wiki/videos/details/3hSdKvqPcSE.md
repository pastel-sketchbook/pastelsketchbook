...
- [Kubernetes Version Upgrade Strategy](https://youtu.be/ftODZr2_V5Q) — Kubernetes · 33 views · Dec 26, 2025 · [Details](ftODZr2_V5Q.md) (shared: `aks` · `cluster`)
...
- [K8s Services  AKS & Istio](https://youtu.be/C5HqbzLRYZ0) — Kubernetes · 52 views · Jan 10, 2026 · [Details](C5HqbzLRYZ0.md) (shared: `aks`)
