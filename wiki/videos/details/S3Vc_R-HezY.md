...
- [The End of the Functional Programming Tax](https://youtu.be/240fOdSvnpk) — Development · 22 views · Jun 14, 2026 · [Details](240fOdSvnpk.md) (shared: `cache` · `layout` · `mutation`)
...
- [A Compiler, Not a Renderer](https://youtu.be/E8f87EV4k3A) — Development · 158 views · Apr 17, 2026 · [Details](E8f87EV4k3A.md) (shared: `pipeline` · `layout`)
