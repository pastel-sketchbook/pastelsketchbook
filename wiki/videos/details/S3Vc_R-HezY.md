...
- [The End of the Functional Programming Tax](https://youtu.be/240fOdSvnpk) — Development · 73 views · Jun 14, 2026 · [Details](240fOdSvnpk.md) (shared: `cache` · `layout` · `mutation`)
- [SlideVoice Studio CLI Architecture](https://youtu.be/ISLXOiFqC50) — Development · 12 views · Jun 19, 2026 · [Details](ISLXOiFqC50.md) (shared: `pipeline` · `gemini` · `ffmpeg`)
