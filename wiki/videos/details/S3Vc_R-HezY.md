...
- [The End of the Functional Programming Tax](https://youtu.be/240fOdSvnpk) — Development · 76 views · Jun 14, 2026 · [Details](240fOdSvnpk.md) (shared: `cache` · `layout` · `mutation`)
...
- [SlideVoice Studio Desktop Shell Architecture](https://youtu.be/ytA6gw6Tgaw) — Development · 33 views · May 17, 2026 · [Details](ytA6gw6Tgaw.md) (shared: `api` · `slide` · `gemini`)
