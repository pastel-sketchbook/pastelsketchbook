...
- [The Local SOTA Engine for Your Digital Brain](https://youtu.be/j8lMpSezavQ) — Development · 57 views · Apr 13, 2026 · [Details](j8lMpSezavQ.md) (shared: `qmd` · `fts5` · `local-first search`)
- [Architecting the Next Evolution of the Local Database](https://youtu.be/EWwk29GzHgg) — Development · 84 views · Apr 27, 2026 · [Details](EWwk29GzHgg.md) (shared: `sqlite` · `search`)
