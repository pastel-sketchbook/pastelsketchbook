...
- [The NestJS Architecture Blueprint](https://youtu.be/173Y2uPljgo) — Development · 50 views · May 4, 2026 · [Details](173Y2uPljgo.md) (shared: `http` · `adapters` · `request`)
- [The Axum Web Framework](https://youtu.be/J4iGUAXcAOA) — Development · 65 views · May 1, 2026 · [Details](J4iGUAXcAOA.md) (shared: `request lifecycle` · `request` · `lifecycle`)
