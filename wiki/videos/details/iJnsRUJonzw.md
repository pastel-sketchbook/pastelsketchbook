...
- [The Open Framework for Building Developer Portals](https://youtu.be/qXg3PQ2kUpI) — Kubernetes · 17 views · Aug 21, 2026 · [Details](qXg3PQ2kUpI.md) (shared: `developer` · `model` · `backstage developer portal`)
