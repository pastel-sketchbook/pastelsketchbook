...
- [Burn: The Rust Deep Learning Framework](https://youtu.be/joYJ6rPN3UI) — Development · 444 views · Feb 13, 2026 · [Details](joYJ6rPN3UI.md) (shared: `rust` · `zero` · `tensor`)
- [The Burn Book](https://youtu.be/B7MMdnv3y1M) — Development · 22 views · May 21, 2026 · [Details](B7MMdnv3y1M.md) (shared: `rust` · `inference` · `tensor`)
- [OpenCV Library Architecture and Capabilities](https://youtu.be/ZfAc2pqcS-4) — Development · 45 views · May 11, 2026 · [Details](ZfAc2pqcS-4.md) (shared: `inference` · `graph` · `cuda`)
- [Burn: The Rust Deep Learning Framework](https://youtu.be/_bFOZ51Q55Y) — Development · 1.4K views · May 8, 2026 · [Details](_bFOZ51Q55Y.md) (shared: `zero` · `copy` · `tensor`)
- [The ONNX Ecosystem](https://youtu.be/Qi_vpz_5j7g) — Development · 43 views · May 10, 2026 · [Details](Qi_vpz_5j7g.md) (shared: `inference` · `graph` · `onnx`)
