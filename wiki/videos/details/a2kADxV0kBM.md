...
- [Bubble Tea v2](https://youtu.be/Hfut9CfJhN0) — Development · 62 views · Mar 2, 2026 · [Details](Hfut9CfJhN0.md) (shared: `terminal ui` · `terminal` · `tui`)
...
- [The Burn Book App Architecture](https://youtu.be/TpyKC8_30xs) — Development · 17 views · May 23, 2026 · [Details](TpyKC8_30xs.md) (shared: `zig` · `terminal` · `architecture`)
- [Reed: The Modern Terminal File Viewer](https://youtu.be/oUTf9j6fWJo) — Development · 145 views · Mar 30, 2026 · [Details](oUTf9j6fWJo.md) (shared: `terminal` · `cli` · `rendering`)
