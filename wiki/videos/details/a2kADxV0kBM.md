...
- [Bubble Tea v2](https://youtu.be/Hfut9CfJhN0) — Development · 56 views · Mar 2, 2026 · [Details](Hfut9CfJhN0.md) (shared: `terminal ui` · `terminal` · `tui`)
...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 790 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `api` · `architecture` · `design`)
