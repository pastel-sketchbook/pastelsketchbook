...
- [Advancing Go Garbage Collection with Green Tea](https://youtu.be/yCJDmGrk8sM) — Development · 199 views · Mar 24, 2026 · [Details](yCJDmGrk8sM.md) (shared: `memory` · `garbage` · `collection`)
...
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 124 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `performance` · `memory` · `cache`)
