...
- [Advancing Go Garbage Collection with Green Tea](https://youtu.be/yCJDmGrk8sM) — Development · 168 views · Mar 24, 2026 · [Details](yCJDmGrk8sM.md) (shared: `memory` · `garbage` · `collection`)
...
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 79 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `performance` · `memory` · `cache`)
- [Burn: The Rust Deep Learning Framework](https://youtu.be/joYJ6rPN3UI) — Development · 570 views · Feb 13, 2026 · [Details](joYJ6rPN3UI.md) (shared: `compile-time` · `data` · `code`)
