...
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 105 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `performance` · `memory` · `cache`)
- [Synthesizing Gleam Syntax with Rust Performance](https://youtu.be/DTb0syknVSQ) — Development · 29 views · Jul 15, 2026 · [Details](DTb0syknVSQ.md) (shared: `functional` · `programming` · `code`)
