...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 835 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `repository pattern` · `repository` · `pattern`)
- [Clean Architecture in Angular](https://youtu.be/RJGNh8L-8rw) — Development · 51 views · Jun 23, 2026 · [Details](RJGNh8L-8rw.md) (shared: `repository` · `pattern` · `signals`)
- [The Compensating Transaction Pattern](https://youtu.be/xlwu0YwE3_Q) — Development · 20 views · Apr 30, 2026 · [Details](xlwu0YwE3_Q.md) (shared: `pattern` · `state management` · `state`)
