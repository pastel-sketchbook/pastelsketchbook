...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 805 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `repository pattern` · `repository` · `pattern`)
- [Clean Architecture in Angular](https://youtu.be/RJGNh8L-8rw) — Development · 42 views · Jun 23, 2026 · [Details](RJGNh8L-8rw.md) (shared: `repository` · `pattern` · `signals`)
