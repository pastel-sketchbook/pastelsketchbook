...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 853 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `repository pattern` · `repository` · `pattern`)
