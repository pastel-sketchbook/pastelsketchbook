...
- [Zero-Trust Database Credentials in Kubernetes](https://youtu.be/nBg53bAuc9A) — Kubernetes · 38 views · Sep 2, 2026 · [Details](nBg53bAuc9A.md) (shared: `workload` · `identity` · `cyberark`)
- [Secure Web App with Azure AD/OAuth2 Proxy](https://youtu.be/rgY4KTMFOMs) — Kubernetes · 83 views · Feb 5, 2026 · [Details](rgY4KTMFOMs.md) (shared: `workload` · `identity` · `authentication`)
