...
- [The Burn Book](https://youtu.be/B7MMdnv3y1M) — Development · 32 views · May 21, 2026 · [Details](B7MMdnv3y1M.md) (shared: `rust` · `burn` · `pipeline`)
- [Mastering Machine Learning in Rust](https://youtu.be/htpvlYnX77w) — Development · 54 views · May 19, 2026 · [Details](htpvlYnX77w.md) (shared: `rust` · `burn` · `learning`)
- [Zig  Pragmatic Successor to C](https://youtu.be/yOOQNnaOLeM) — Development · 28 views · Jan 9, 2026 · [Details](yOOQNnaOLeM.md) (shared: `rust` · `learning`)
