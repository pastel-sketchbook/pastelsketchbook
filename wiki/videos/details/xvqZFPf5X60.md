...
- [Building vibe-rust](https://youtu.be/BT08SXPvV6U) — Development · 65 views · Apr 4, 2026 · [Details](BT08SXPvV6U.md) (shared: `text-to-speech` · `tts` · `stt`)
...
- [Modern State Architecture: The Repository Pattern](https://youtu.be/3ybGkjogcFQ) — Development · 37 views · Feb 20, 2026 · [Details](3ybGkjogcFQ.md) (shared: `tanstack` · `architecture`)
