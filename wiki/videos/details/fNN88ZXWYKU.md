...
- [The Universal Engine for LLM Inference](https://youtu.be/OKXt-PJUuzE) — Development · 96 views · Jun 21, 2026 · [Details](OKXt-PJUuzE.md) (shared: `cache` · `quantization` · `hardware`)
- [DwarfStar DS4 Technical Architecture](https://youtu.be/nSMpZpj6Jzc) — Development · 38 views · Aug 14, 2026 · [Details](nSMpZpj6Jzc.md) (shared: `inference` · `cache` · `quantization`)
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 124 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `engineering` · `cache` · `design`)
