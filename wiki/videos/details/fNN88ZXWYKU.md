...
- [The Universal Engine for LLM Inference](https://youtu.be/OKXt-PJUuzE) — Development · 82 views · Jun 21, 2026 · [Details](OKXt-PJUuzE.md) (shared: `cache` · `quantization` · `hardware`)
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 92 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `engineering` · `cache` · `design`)
- [The Confluent Systems Master Plan](https://youtu.be/J6dRkXZhnIQ) — Development · 70 views · Jul 9, 2026 · [Details](J6dRkXZhnIQ.md) (shared: `engineering` · `systems` · `gpu`)
