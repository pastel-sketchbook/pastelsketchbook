...
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 69 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `engineering` · `cache` · `design`)
...
- [The Memory Management Trilemma](https://youtu.be/axvxGj3yOgA) — Development · 32 views · Jan 6, 2026 · [Details](axvxGj3yOgA.md) (shared: `systems` · `design`)
