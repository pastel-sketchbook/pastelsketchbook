...
- [Secure Web App with Azure AD/OAuth2 Proxy](https://youtu.be/rgY4KTMFOMs) — Kubernetes · 83 views · Feb 5, 2026 · [Details](rgY4KTMFOMs.md) (shared: `azure` · `identity` · `authentication`)
- [Modernizing Kubernetes Secrets Management](https://youtu.be/LgFYohNPByM) — Kubernetes · 30 views · Sep 6, 2026 · [Details](LgFYohNPByM.md) (shared: `identity` · `authentication` · `service`)
