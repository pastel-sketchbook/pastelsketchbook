...
- [Seamless GitOps on Azure](https://youtu.be/9ga0NT3ZohQ) — Kubernetes · 17 views · May 22, 2026 · [Details](9ga0NT3ZohQ.md) (shared: `aks` · `deployment` · `architecture`)
- [Secure Web App with Azure AD/OAuth2 Proxy](https://youtu.be/rgY4KTMFOMs) — Kubernetes · 82 views · Feb 5, 2026 · [Details](rgY4KTMFOMs.md) (shared: `aks` · `architecture` · `istio`)
...
- [K8s Services  AKS & Istio](https://youtu.be/C5HqbzLRYZ0) — Kubernetes · 32 views · Jan 10, 2026 · [Details](C5HqbzLRYZ0.md) (shared: `aks` · `istio`)
