...
- [Secure Web App with Azure AD/OAuth2 Proxy](https://youtu.be/rgY4KTMFOMs) — Kubernetes · 73 views · Feb 5, 2026 · [Details](rgY4KTMFOMs.md) (shared: `aks` · `architecture` · `istio`)
