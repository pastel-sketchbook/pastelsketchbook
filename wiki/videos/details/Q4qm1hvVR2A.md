...
- [Seamless GitOps on Azure](https://youtu.be/9ga0NT3ZohQ) — Kubernetes · 12 views · May 22, 2026 · [Details](9ga0NT3ZohQ.md) (shared: `aks` · `deployment` · `architecture`)
...
- [K8s Services  AKS & Istio](https://youtu.be/C5HqbzLRYZ0) — Kubernetes · 23 views · Jan 10, 2026 · [Details](C5HqbzLRYZ0.md) (shared: `aks` · `istio`)
