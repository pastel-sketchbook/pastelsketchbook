...
- [Design for Deletion](https://youtu.be/yAeM2vpPWeM) — Development · 152 views · Apr 25, 2026 · [Details](yAeM2vpPWeM.md) (shared: `slices` · `technical` · `debt`)
...
- [Mastering Go Pointers](https://youtu.be/VHuQi_1t5qQ) — Development · 75 views · Apr 17, 2026 · [Details](VHuQi_1t5qQ.md) (shared: `analysis` · `slices`)
