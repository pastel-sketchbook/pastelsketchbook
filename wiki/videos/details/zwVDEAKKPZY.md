...
- [Design for Deletion](https://youtu.be/yAeM2vpPWeM) — Development · 150 views · Apr 25, 2026 · [Details](yAeM2vpPWeM.md) (shared: `slices` · `technical` · `debt`)
...
- [Mastering Go Pointers](https://youtu.be/VHuQi_1t5qQ) — Development · 74 views · Apr 17, 2026 · [Details](VHuQi_1t5qQ.md) (shared: `analysis` · `slices`)
