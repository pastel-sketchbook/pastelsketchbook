...
- [How to Kill the Code Review](https://youtu.be/0HEqwk9UMOc) — Development · 139 views · Mar 18, 2026 · [Details](0HEqwk9UMOc.md) (shared: `workflow` · `automation` · `architectural`)
- [Engineering the Overnight Researcher in Zig](https://youtu.be/7yqkfHo8Mwk) — Development · 74 views · Mar 9, 2026 · [Details](7yqkfHo8Mwk.md) (shared: `model` · `optimization` · `automation`)
