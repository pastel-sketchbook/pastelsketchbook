...
- [Neural TTS in Pastel-HN](https://youtu.be/d_0swhS1LyQ) — Development · 47 views · Feb 1, 2026 · [Details](d_0swhS1LyQ.md) (shared: `rust` · `onnx runtime` · `onnx`)
...
- [Tokio: The Asynchronous Runtime for Rust](https://youtu.be/0Sed1oggMKY) — Development · 92 views · Feb 8, 2026 · [Details](0Sed1oggMKY.md) (shared: `rust` · `runtime`)
- [The Rust Architect's Sketchbook](https://youtu.be/7zFqW-ZcEbo) — Development · 96 views · Jan 8, 2026 · [Details](7zFqW-ZcEbo.md) (shared: `runtime` · `rayon` · `parallelism`)
