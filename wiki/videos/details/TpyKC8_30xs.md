...
- [The Burn Book](https://youtu.be/B7MMdnv3y1M) — Development · 34 views · May 21, 2026 · [Details](B7MMdnv3y1M.md) (shared: `architecture` · `burn deep learning framework` · `burn`)
...
- [SlideVoice Studio Desktop Shell Architecture](https://youtu.be/ytA6gw6Tgaw) — Development · 34 views · May 17, 2026 · [Details](ytA6gw6Tgaw.md) (shared: `architecture` · `tauri 2 desktop shell` · `tauri`)
