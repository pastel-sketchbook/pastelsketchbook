...
- [The Burn Book](https://youtu.be/B7MMdnv3y1M) — Development · 28 views · May 21, 2026 · [Details](B7MMdnv3y1M.md) (shared: `architecture` · `burn deep learning framework` · `burn`)
...
- [The Architecture of tracel-ai/models](https://youtu.be/kSQtbPEtDkY) — Development · 16 views · May 20, 2026 · [Details](kSQtbPEtDkY.md) (shared: `architecture` · `burn` · `deep`)
