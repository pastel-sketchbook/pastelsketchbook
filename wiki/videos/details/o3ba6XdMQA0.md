...
- [The Rust Architect's Sketchbook](https://youtu.be/7zFqW-ZcEbo) — Development · 96 views · Jan 8, 2026 · [Details](7zFqW-ZcEbo.md) (shared: `grpc` · `axum` · `tokio async runtime`)
...
- [Architecture Review: tn-file-upload](https://youtu.be/UOOkDh4RUbE) — Development · 31 views · May 4, 2026 · [Details](UOOkDh4RUbE.md) (shared: `grpc` · `streaming` · `axum`)
...
- [Architecting with Tonic](https://youtu.be/90hw9qwXbbw) — Development · 162 views · May 2, 2026 · [Details](90hw9qwXbbw.md) (shared: `grpc` · `tokio` · `async`)
