...
- [Let's check about Zig](https://youtu.be/olsB3bJxA2A) — Development · 356 views · Dec 28, 2025 · [Details](olsB3bJxA2A.md) (shared: `safety` · `memory management` · `memory`)
...
- [A Guide to Rust Smart Pointers](https://youtu.be/WdK7PED1ug8) — Development · 50 views · Feb 26, 2026 · [Details](WdK7PED1ug8.md) (shared: `rust` · `smart` · `pointers`)
