...
- [Mastering Machine Learning in Rust](https://youtu.be/htpvlYnX77w) — Development · 62 views · May 19, 2026 · [Details](htpvlYnX77w.md) (shared: `ndarray` · `rust` · `numerical`)
- [Cross-Runtime Development with Rust and napi-rs](https://youtu.be/97zSu6wYF5w) — Development · 73 views · Jul 10, 2026 · [Details](97zSu6wYF5w.md) (shared: `crate` · `macro` · `type`)
