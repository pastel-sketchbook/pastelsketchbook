...
- [Mastering Machine Learning in Rust](https://youtu.be/htpvlYnX77w) — Development · 35 views · May 19, 2026 · [Details](htpvlYnX77w.md) (shared: `ndarray` · `rust` · `numerical`)
- [Rust 1.95.0](https://youtu.be/izLrX-02IQk) — Development · 218 views · Apr 18, 2026 · [Details](izLrX-02IQk.md) (shared: `crate` · `macro` · `rust`)
