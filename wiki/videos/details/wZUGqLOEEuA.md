...
- [Architecting Multi-Rail Fabrics for On-Premise AI Inference](https://youtu.be/sQz9WyN2s04) — Kubernetes · 138 views · Sep 4, 2026 · [Details](sQz9WyN2s04.md) (shared: `disaggregated` · `prefill` · `decode`)
