...
- [SlideVoice Studio Desktop Shell Architecture](https://youtu.be/ytA6gw6Tgaw) — Development · 33 views · May 17, 2026 · [Details](ytA6gw6Tgaw.md) (shared: `content` · `security`)
- [Stitch Agent Skills](https://youtu.be/fv61JXUCbeo) — Development · 290 views · Apr 5, 2026 · [Details](fv61JXUCbeo.md) (shared: `google` · `validation`)
- [The Engine of a Modern Task Runner](https://youtu.be/sMo3KnNup34) — Development · 106 views · Aug 1, 2026 · [Details](sMo3KnNup34.md) (shared: `file` · `detection`)
