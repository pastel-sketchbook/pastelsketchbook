...
- [Modernizing Kubernetes Secrets Management](https://youtu.be/LgFYohNPByM) — Kubernetes · 39 views · Sep 6, 2026 · [Details](LgFYohNPByM.md) (shared: `secrets` · `exchange` · `rotation`)
