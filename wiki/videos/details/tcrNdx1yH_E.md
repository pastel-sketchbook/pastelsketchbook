...
- [Drasi: The Future of Change-Driven Architecture](https://youtu.be/5Ztm7JNVa8E) — Kubernetes · 52 views · Feb 17, 2026 · [Details](5Ztm7JNVa8E.md) (shared: `data` · `event-driven architecture` · `event-driven`)
