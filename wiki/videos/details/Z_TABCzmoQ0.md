...
- [The Memory Management Trilemma](https://youtu.be/axvxGj3yOgA) — Development · 39 views · Jan 6, 2026 · [Details](axvxGj3yOgA.md) (shared: `language` · `memory` · `ownership`)
...
- [zig-duckdb-ext](https://youtu.be/ymYtSum-2qc) — Development · 66 views · Mar 24, 2026 · [Details](ymYtSum-2qc.md) (shared: `interop` · `comptime` · `zero-cost`)
