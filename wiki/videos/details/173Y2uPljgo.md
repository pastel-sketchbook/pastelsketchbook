...
- [Architecting Network Layers with Dio](https://youtu.be/BhzeYd4aqOQ) — Development · 22 views · May 16, 2026 · [Details](BhzeYd4aqOQ.md) (shared: `request` · `pipeline` · `http`)
...
- [Cross-Runtime Development with Rust and napi-rs](https://youtu.be/97zSu6wYF5w) — Development · 47 views · Jul 10, 2026 · [Details](97zSu6wYF5w.md) (shared: `module` · `pipeline` · `hybrid`)
...
<!-- book-classification -->
_Belongs to: **[The Architect's Sketchbook](zmd://wiki/books/architects-sketchbook.md) — Chapter 10** (confidence: 30%)_
