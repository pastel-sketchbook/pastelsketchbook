...
- [zig-twitter: Anatomy of a Hybrid Terminal Client](https://youtu.be/a2kADxV0kBM) — Development · 34 views · Mar 14, 2026 · [Details](a2kADxV0kBM.md) (shared: `api` · `architecture` · `cli`)
- [OpenCV Library Architecture and Capabilities](https://youtu.be/ZfAc2pqcS-4) — Development · 46 views · May 11, 2026 · [Details](ZfAc2pqcS-4.md) (shared: `api` · `architecture` · `module`)
...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 794 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `api` · `architecture` · `dependency`)
- [The Blueprint of Reactivity](https://youtu.be/Gy-ky1pAF0U) — Development · 25 views · May 16, 2026 · [Details](Gy-ky1pAF0U.md) (shared: `architecture` · `dependency` · `graph`)
