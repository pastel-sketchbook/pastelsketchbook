...
- [K8s Services  AKS & Istio](https://youtu.be/C5HqbzLRYZ0) — Kubernetes · 23 views · Jan 10, 2026 · [Details](C5HqbzLRYZ0.md) (shared: `kubernetes services` · `kubernetes` · `services`)
...
- [Architecting the Modern Cloud Network](https://youtu.be/1RqgRdlIO8M) — Kubernetes · 15 views · Jul 19, 2026 · [Details](1RqgRdlIO8M.md) (shared: `istio` · `service` · `mesh`)
