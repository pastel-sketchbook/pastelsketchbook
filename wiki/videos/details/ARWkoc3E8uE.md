...
- [Architecting with Tonic](https://youtu.be/90hw9qwXbbw) — Development · 140 views · May 2, 2026 · [Details](90hw9qwXbbw.md) (shared: `rust` · `traits` · `architecture`)
...
- [Design for Deletion](https://youtu.be/yAeM2vpPWeM) — Development · 154 views · Apr 25, 2026 · [Details](yAeM2vpPWeM.md) (shared: `composition` · `design` · `architecture`)
