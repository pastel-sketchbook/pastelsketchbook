...
- [The Memory Management Trilemma](https://youtu.be/axvxGj3yOgA) — Development · 37 views · Jan 6, 2026 · [Details](axvxGj3yOgA.md) (shared: `rust` · `zig` · `manual memory management`)
- [Zig  Pragmatic Successor to C](https://youtu.be/yOOQNnaOLeM) — Development · 28 views · Jan 9, 2026 · [Details](yOOQNnaOLeM.md) (shared: `rust` · `zig` · `memory`)
- [The Hybrid TUI Architecture](https://youtu.be/IZX3_9rZeMU) — Development · 553 views · Feb 10, 2026 · [Details](IZX3_9rZeMU.md) (shared: `ffi` · `interface` · `memory`)
...
- [Let's check about Zig](https://youtu.be/olsB3bJxA2A) — Development · 358 views · Dec 28, 2025 · [Details](olsB3bJxA2A.md) (shared: `zig` · `memory` · `management`)
