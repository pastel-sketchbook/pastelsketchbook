...
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 127 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `zig` · `memory` · `layout`)
...
- [Cloth Simulation: A Performance Study](https://youtu.be/US7oyxbcJCc) — Development · 16 views · Jan 25, 2026 · [Details](US7oyxbcJCc.md) (shared: `zig` · `data-oriented design` · `data-oriented`)
...
- [The Memory Management Trilemma](https://youtu.be/axvxGj3yOgA) — Development · 39 views · Jan 6, 2026 · [Details](axvxGj3yOgA.md) (shared: `zig` · `memory` · `design`)
