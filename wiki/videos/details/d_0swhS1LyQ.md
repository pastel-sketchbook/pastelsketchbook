...
- [Building vibe-rust](https://youtu.be/BT08SXPvV6U) — Development · 66 views · Apr 4, 2026 · [Details](BT08SXPvV6U.md) (shared: `tts` · `onnx runtime` · `onnx`)
...
- [Architecting with Tonic](https://youtu.be/90hw9qwXbbw) — Development · 157 views · May 2, 2026 · [Details](90hw9qwXbbw.md) (shared: `runtime` · `rust`)
