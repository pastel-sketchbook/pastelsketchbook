...
- [Backend Patterns in Rust](https://youtu.be/Th5MMOFQbh8) — Development · 49 views · Feb 22, 2026 · [Details](Th5MMOFQbh8.md) (shared: `rust` · `backend` · `architecture`)
...
- [melos-rs: Architectural Anatomy](https://youtu.be/WahgsFhj3W0) — Development · 20 views · Mar 1, 2026 · [Details](WahgsFhj3W0.md) (shared: `rust` · `facade pattern` · `facade`)
- [Tokio: The Asynchronous Runtime for Rust](https://youtu.be/0Sed1oggMKY) — Development · 90 views · Feb 8, 2026 · [Details](0Sed1oggMKY.md) (shared: `rust` · `architecture` · `async`)
