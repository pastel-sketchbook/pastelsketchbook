...
- [Shannon: Autonomous Penetration Testing](https://youtu.be/JfGgWiiCTA0) — Security · 67 views · Feb 14, 2026 · [Details](JfGgWiiCTA0.md) (shared: `security` · `vulnerability`)
...
- [The Joy of Cryptography](https://youtu.be/7dsz_yUpvqM) — Security · 24 views · Jul 27, 2026 · [Details](7dsz_yUpvqM.md) (shared: `attack` · `security`)
