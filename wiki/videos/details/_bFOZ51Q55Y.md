...
- [Burn: The Rust Deep Learning Framework](https://youtu.be/joYJ6rPN3UI) — Development · 588 views · Feb 13, 2026 · [Details](joYJ6rPN3UI.md) (shared: `tensor` · `zero` · `learning`)
- [The Burn Book](https://youtu.be/B7MMdnv3y1M) — Development · 31 views · May 21, 2026 · [Details](B7MMdnv3y1M.md) (shared: `hardware` · `tensor` · `training`)
- [Candle: A Minimalist Framework for Serverless ML Inference](https://youtu.be/8PaVKQoDReY) — Development · 79 views · May 9, 2026 · [Details](8PaVKQoDReY.md) (shared: `tensor` · `zero` · `copy`)
...
- [Mapping the NVIDIA CUDA Library Ecosystem](https://youtu.be/9tiUYnQL_y0) — Development · 13 views · Jun 20, 2026 · [Details](9tiUYnQL_y0.md) (shared: `tensor` · `kernel` · `fusion`)
