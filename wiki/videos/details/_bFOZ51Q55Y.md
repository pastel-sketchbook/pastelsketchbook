...
- [Burn: The Rust Deep Learning Framework](https://youtu.be/joYJ6rPN3UI) — Development · 947 views · Feb 13, 2026 · [Details](joYJ6rPN3UI.md) (shared: `tensor` · `zero` · `learning`)
- [The Burn Book](https://youtu.be/B7MMdnv3y1M) — Development · 33 views · May 21, 2026 · [Details](B7MMdnv3y1M.md) (shared: `hardware` · `tensor` · `training`)
