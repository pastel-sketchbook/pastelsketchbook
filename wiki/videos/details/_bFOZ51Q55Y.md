...
- [Burn: The Rust Deep Learning Framework](https://youtu.be/joYJ6rPN3UI) — Development · 548 views · Feb 13, 2026 · [Details](joYJ6rPN3UI.md) (shared: `tensor` · `zero` · `learning`)
...
- [Candle: A Minimalist Framework for Serverless ML Inference](https://youtu.be/8PaVKQoDReY) — Development · 77 views · May 9, 2026 · [Details](8PaVKQoDReY.md) (shared: `tensor` · `zero` · `copy`)
...
- [The PyTorch Architecture Blueprint](https://youtu.be/KXx_6BhzOFE) — Development · 40 views · Jun 13, 2026 · [Details](KXx_6BhzOFE.md) (shared: `kernel` · `pytorch` · `dispatch`)
