...
- [Burn: The Rust Deep Learning Framework](https://youtu.be/joYJ6rPN3UI) — Development · 448 views · Feb 13, 2026 · [Details](joYJ6rPN3UI.md) (shared: `tensor` · `zero` · `learning`)
- [The Burn Book](https://youtu.be/B7MMdnv3y1M) — Development · 27 views · May 21, 2026 · [Details](B7MMdnv3y1M.md) (shared: `hardware` · `tensor` · `training`)
- [Candle: A Minimalist Framework for Serverless ML Inference](https://youtu.be/8PaVKQoDReY) — Development · 60 views · May 9, 2026 · [Details](8PaVKQoDReY.md) (shared: `tensor` · `zero` · `copy`)
- [The ONNX Ecosystem](https://youtu.be/Qi_vpz_5j7g) — Development · 44 views · May 10, 2026 · [Details](Qi_vpz_5j7g.md) (shared: `hardware` · `serialization` · `adapters`)
