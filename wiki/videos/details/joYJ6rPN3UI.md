...
- [The Burn Book](https://youtu.be/B7MMdnv3y1M) — Development · 34 views · May 21, 2026 · [Details](B7MMdnv3y1M.md) (shared: `rust` · `deep` · `learning`)
- [Candle: A Minimalist Framework for Serverless ML Inference](https://youtu.be/8PaVKQoDReY) — Development · 110 views · May 9, 2026 · [Details](8PaVKQoDReY.md) (shared: `rust` · `tensor` · `automatic`)
...
- [Mastering Memory in Rust](https://youtu.be/43UjmZtW2JU) — Development · 54 views · Jan 27, 2026 · [Details](43UjmZtW2JU.md) (shared: `rust` · `compile-time` · `safety`)
