...
- [The Burn Book](https://youtu.be/B7MMdnv3y1M) — Development · 29 views · May 21, 2026 · [Details](B7MMdnv3y1M.md) (shared: `rust` · `deep` · `learning`)
- [Candle: A Minimalist Framework for Serverless ML Inference](https://youtu.be/8PaVKQoDReY) — Development · 72 views · May 9, 2026 · [Details](8PaVKQoDReY.md) (shared: `rust` · `tensor` · `automatic`)
...
- [Blueprinting Machine Learning in Rust](https://youtu.be/KR188eZ9gRE) — Development · 26 views · May 20, 2026 · [Details](KR188eZ9gRE.md) (shared: `rust` · `learning` · `safety`)
