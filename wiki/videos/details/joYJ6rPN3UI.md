...
- [The Burn Book](https://youtu.be/B7MMdnv3y1M) — Development · 27 views · May 21, 2026 · [Details](B7MMdnv3y1M.md) (shared: `rust` · `deep` · `learning`)
- [Candle: A Minimalist Framework for Serverless ML Inference](https://youtu.be/8PaVKQoDReY) — Development · 60 views · May 9, 2026 · [Details](8PaVKQoDReY.md) (shared: `rust` · `tensor` · `automatic`)
