...
- [Candle: A Minimalist Framework for Serverless ML Inference](https://youtu.be/8PaVKQoDReY) — Development · 85 views · May 9, 2026 · [Details](8PaVKQoDReY.md) (shared: `rust` · `tensor` · `automatic`)
