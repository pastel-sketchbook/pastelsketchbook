...
- [The PyTorch Architecture Blueprint](https://youtu.be/KXx_6BhzOFE) — Development · 52 views · Jun 13, 2026 · [Details](KXx_6BhzOFE.md) (shared: `kernel` · `dynamic`)
- [DwarfStar DS4 Technical Architecture](https://youtu.be/nSMpZpj6Jzc) — Development · 17 views · Aug 14, 2026 · [Details](nSMpZpj6Jzc.md) (shared: `tensor` · `mixed`)
