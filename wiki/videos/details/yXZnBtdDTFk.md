...
- [The Strangler Fig Pattern](https://youtu.be/4aAyFYemYD8) — Development · 46 views · Apr 28, 2026 · [Details](4aAyFYemYD8.md) (shared: `migration` · `strangler fig pattern` · `strangler`)
...
- [Reins: The Framework for Al-Assisted Development](https://youtu.be/zrP3muXzQX4) — Development · 74 views · Mar 23, 2026 · [Details](zrP3muXzQX4.md) (shared: `context` · `guardrails`)
