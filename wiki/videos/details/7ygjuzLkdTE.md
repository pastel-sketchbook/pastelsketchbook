...
- [The Rust Robotics Paradigm](https://youtu.be/gPnrk5TNKWg) — Development · 63 views · Jun 27, 2026 · [Details](gPnrk5TNKWg.md) (shared: `robotics` · `ros` · `zero-copy`)
- [Zig  Pragmatic Successor to C](https://youtu.be/yOOQNnaOLeM) — Development · 27 views · Jan 9, 2026 · [Details](yOOQNnaOLeM.md) (shared: `rust` · `systems` · `programming`)
