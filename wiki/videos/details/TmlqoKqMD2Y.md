...
- [Jujutsu (jj):  An Introduction of its Paradigm Shift](https://youtu.be/5st-kLcNrE8) — Development · 125 views · Feb 5, 2026 · [Details](5st-kLcNrE8.md) (shared: `jujutsu` · `git compatibility` · `git`)
