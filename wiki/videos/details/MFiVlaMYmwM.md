...
- [Zero Trust in Kubernetes](https://youtu.be/4b-H6ZaoNUE) — Kubernetes · 42 views · Jan 17, 2026 · [Details](4b-H6ZaoNUE.md) (shared: `zero` · `trust` · `identity`)
- [The Strategic Roadmap for Data Classification](https://youtu.be/uhXcsWYhdkA) — Security · 17 views · Mar 2, 2026 · [Details](uhXcsWYhdkA.md) (shared: `zero` · `trust` · `security`)
...
- [ZAP: Getting Started with Software Security Testing](https://youtu.be/infh5ZZwvLU) — Security · 26 views · Apr 30, 2026 · [Details](infh5ZZwvLU.md) (shared: `owasp` · `security`)
