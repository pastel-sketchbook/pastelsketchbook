...
- [Serverless Analytics with DuckDB & Python](https://youtu.be/ZBW6YozOu78) — Development · 50 views · Mar 14, 2026 · [Details](ZBW6YozOu78.md) (shared: `python` · `workflow`)
- [Architecting Modern JavaScript Modules](https://youtu.be/Fqokr0P2_ag) — Development · 18 views · May 25, 2026 · [Details](Fqokr0P2_ag.md) (shared: `tooling` · `static`)
