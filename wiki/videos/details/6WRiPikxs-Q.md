...
- [Production-Ready RabbitMQ in Go](https://youtu.be/CXtHwJQphLI) — Development · 111 views · Mar 19, 2026 · [Details](CXtHwJQphLI.md) (shared: `architecture` · `opentelemetry` · `distributed`)
...
- [Modern Observability in Go](https://youtu.be/uqZ-mwxGf2c) — Development · 126 views · Mar 1, 2026 · [Details](uqZ-mwxGf2c.md) (shared: `opentelemetry` · `distributed` · `context`)
- [The Compensating Transaction Pattern](https://youtu.be/xlwu0YwE3_Q) — Development · 21 views · Apr 30, 2026 · [Details](xlwu0YwE3_Q.md) (shared: `architecture` · `distributed` · `management`)
