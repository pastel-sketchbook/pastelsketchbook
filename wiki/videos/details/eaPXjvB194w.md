...
- [Secure Web App with Azure AD/OAuth2 Proxy](https://youtu.be/rgY4KTMFOMs) — Kubernetes · 61 views · Feb 5, 2026 · [Details](rgY4KTMFOMs.md) (shared: `azure` · `workload`)
- [AWS Database Selection Blueprint](https://youtu.be/78Sm363xiIw) — Kubernetes · 11 views · Jun 12, 2026 · [Details](78Sm363xiIw.md) (shared: `cost` · `modeling`)
