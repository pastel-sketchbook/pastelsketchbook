...
- [Secure Web App with Azure AD/OAuth2 Proxy](https://youtu.be/rgY4KTMFOMs) — Kubernetes · 56 views · Feb 5, 2026 · [Details](rgY4KTMFOMs.md) (shared: `azure` · `workload`)
- [Seamless GitOps on Azure](https://youtu.be/9ga0NT3ZohQ) — Kubernetes · 10 views · May 22, 2026 · [Details](9ga0NT3ZohQ.md) (shared: `azure` · `workload`)
