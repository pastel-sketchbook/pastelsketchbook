...
- [DevSecOps on Azure Kubernetes Service](https://youtu.be/-e7kvcUXxtw) — Kubernetes · 23 views · Apr 29, 2026 · [Details](-e7kvcUXxtw.md) (shared: `azure` · `modeling`)
...
- [Secure Web App with Azure AD/OAuth2 Proxy](https://youtu.be/rgY4KTMFOMs) — Kubernetes · 51 views · Feb 5, 2026 · [Details](rgY4KTMFOMs.md) (shared: `azure` · `workload`)
