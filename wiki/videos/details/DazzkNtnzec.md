...
- [Backend Patterns in Rust](https://youtu.be/Th5MMOFQbh8) — Development · 50 views · Feb 22, 2026 · [Details](Th5MMOFQbh8.md) (shared: `dependency injection` · `dependency` · `injection`)
...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 853 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `dependency injection` · `dependency` · `injection`)
