...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 780 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `dependency injection` · `dependency` · `injection`)
- [Hangul Typing](https://youtu.be/Pp36ysjfWd8) — Development · 8 views · Jan 22, 2026 · [Details](Pp36ysjfWd8.md) (shared: `composition` · `typing`)
