...
- [The Architecture of Systemic Decoupling](https://youtu.be/R3n8UxyD7mc) — Development · 54 views · Apr 27, 2026 · [Details](R3n8UxyD7mc.md) (shared: `principle` · `dependency injection` · `dependency`)
...
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 785 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `dependency injection` · `dependency` · `injection`)
