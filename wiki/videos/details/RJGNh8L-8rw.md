...
- [Modern State Architecture: The Repository Pattern](https://youtu.be/3ybGkjogcFQ) — Development · 39 views · Feb 20, 2026 · [Details](3ybGkjogcFQ.md) (shared: `architecture` · `angular` · `signals`)
- [The Repository Pattern](https://youtu.be/cWozmWrqnxs) — Development · 841 views · Feb 13, 2026 · [Details](cWozmWrqnxs.md) (shared: `architecture` · `repository` · `pattern`)
