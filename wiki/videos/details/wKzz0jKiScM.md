...
- [ZMD Architecture & Evolution](https://youtu.be/xkHQhOgapfY) — Development · 47 views · Apr 21, 2026 · [Details](xkHQhOgapfY.md) (shared: `tree-sitter`)
- [The Strangler Fig Pattern](https://youtu.be/4aAyFYemYD8) — Development · 96 views · Apr 28, 2026 · [Details](4aAyFYemYD8.md) (shared: `migration`)
- [Mastering Machine Learning in Rust](https://youtu.be/htpvlYnX77w) — Development · 65 views · May 19, 2026 · [Details](htpvlYnX77w.md) (shared: `migration`)
- [The Transport Revolution: Deconstructing HTTP/3](https://youtu.be/JWeu5aqAkR0) — Development · 212 views · Apr 1, 2026 · [Details](JWeu5aqAkR0.md) (shared: `migration`)
