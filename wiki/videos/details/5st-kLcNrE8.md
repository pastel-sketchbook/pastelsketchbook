...
- [Jujutsu (jj) for Git-compatible Workflow](https://youtu.be/TmlqoKqMD2Y) — Development · 385 views · Feb 5, 2026 · [Details](TmlqoKqMD2Y.md) (shared: `jujutsu` · `git compatibility` · `git`)
- [Local Change Data Capture at Scale](https://youtu.be/FIelcuTti-I) — Development · 24 views · May 26, 2026 · [Details](FIelcuTti-I.md) (shared: `compatibility` · `change`)
