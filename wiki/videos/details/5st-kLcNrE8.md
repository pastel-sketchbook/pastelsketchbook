...
- [Jujutsu (jj) for Git-compatible Workflow](https://youtu.be/TmlqoKqMD2Y) — Development · 170 views · Feb 5, 2026 · [Details](TmlqoKqMD2Y.md) (shared: `jujutsu` · `git compatibility` · `git`)
- [The 2026 Change Data Capture Blueprint](https://youtu.be/am9FvNiJ24M) — Development · 29 views · Apr 8, 2026 · [Details](am9FvNiJ24M.md) (shared: `change`)
...
- [Hyper: The Foundation of Fast HTTP in Rust](https://youtu.be/DwAOCljoNoc) — Development · 86 views · May 2, 2026 · [Details](DwAOCljoNoc.md) (shared: `compatibility`)
