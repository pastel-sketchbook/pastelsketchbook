...
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 114 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `optimization` · `engineering` · `memory`)
...
- [Zig  Pragmatic Successor to C](https://youtu.be/yOOQNnaOLeM) — Development · 29 views · Jan 9, 2026 · [Details](yOOQNnaOLeM.md) (shared: `systems` · `learning` · `memory`)
