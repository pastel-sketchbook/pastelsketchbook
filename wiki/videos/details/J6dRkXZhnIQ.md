...
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 85 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `optimization` · `engineering` · `memory`)
...
- [The Anatomy of a Modern Robot](https://youtu.be/7ygjuzLkdTE) — Development · 44 views · Jun 24, 2026 · [Details](7ygjuzLkdTE.md) (shared: `llm` · `systems` · `zero-copy`)
- [Zig  Pragmatic Successor to C](https://youtu.be/yOOQNnaOLeM) — Development · 26 views · Jan 9, 2026 · [Details](yOOQNnaOLeM.md) (shared: `systems` · `learning` · `memory`)
