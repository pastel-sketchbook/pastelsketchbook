...
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 87 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `optimization` · `engineering` · `memory`)
...
- [The Anatomy of a Modern Robot](https://youtu.be/7ygjuzLkdTE) — Development · 45 views · Jun 24, 2026 · [Details](7ygjuzLkdTE.md) (shared: `llm` · `systems` · `zero-copy`)
