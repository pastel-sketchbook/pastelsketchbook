...
- [Secure Web App with Azure AD/OAuth2 Proxy](https://youtu.be/rgY4KTMFOMs) — Kubernetes · 95 views · Feb 5, 2026 · [Details](rgY4KTMFOMs.md) (shared: `authentication` · `identity` · `zero trust architecture`)
...
- [Microsoft Agent Governance Toolkit](https://youtu.be/MFiVlaMYmwM) — Security · 286 views · May 22, 2026 · [Details](MFiVlaMYmwM.md) (shared: `identity` · `zero` · `trust`)
