...
- [Secure Web App with Azure AD/OAuth2 Proxy](https://youtu.be/rgY4KTMFOMs) — Kubernetes · 87 views · Feb 5, 2026 · [Details](rgY4KTMFOMs.md) (shared: `authentication` · `identity` · `zero trust architecture`)
...
- [The Strategic Roadmap for Data Classification](https://youtu.be/uhXcsWYhdkA) — Security · 25 views · Mar 2, 2026 · [Details](uhXcsWYhdkA.md) (shared: `zero trust architecture` · `zero` · `trust`)
...
- [Microsoft Agent Governance Toolkit](https://youtu.be/MFiVlaMYmwM) — Security · 276 views · May 22, 2026 · [Details](MFiVlaMYmwM.md) (shared: `identity` · `zero` · `trust`)
