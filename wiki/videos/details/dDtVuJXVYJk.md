...
- [Bulletproof Frontend Architecture](https://youtu.be/5Vloo08zQ7o) — Development · 35 views · Feb 16, 2026 · [Details](5Vloo08zQ7o.md) (shared: `normalization` · `data` · `architecture`)
...
- [Building Production-Grade RabbitMQ in Go](https://youtu.be/IYfTi_HNDl4) — Development · 85 views · Apr 6, 2026 · [Details](IYfTi_HNDl4.md) (shared: `distributed` · `architecture`)
...
- [Production-Ready RabbitMQ in Go](https://youtu.be/CXtHwJQphLI) — Development · 144 views · Mar 19, 2026 · [Details](CXtHwJQphLI.md) (shared: `distributed` · `architecture`)
