...
- [Bulletproof Frontend Architecture](https://youtu.be/5Vloo08zQ7o) — Development · 33 views · Feb 16, 2026 · [Details](5Vloo08zQ7o.md) (shared: `normalization` · `data` · `architecture`)
...
- [Production-Ready RabbitMQ in Go](https://youtu.be/CXtHwJQphLI) — Development · 111 views · Mar 19, 2026 · [Details](CXtHwJQphLI.md) (shared: `distributed` · `architecture`)
