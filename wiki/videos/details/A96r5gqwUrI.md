...
- [zig-duckdb-ext](https://youtu.be/ymYtSum-2qc) — Development · 63 views · Mar 24, 2026 · [Details](ymYtSum-2qc.md) (shared: `zig` · `comptime` · `zero-cost`)
...
- [OpenCV Library Architecture and Capabilities](https://youtu.be/ZfAc2pqcS-4) — Development · 43 views · May 11, 2026 · [Details](ZfAc2pqcS-4.md) (shared: `abstraction` · `simd` · `optimization`)
