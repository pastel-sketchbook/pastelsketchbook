...
- [Mastering Serde in Rust ](https://youtu.be/RDa6WtZmW8E) — Development · 49 views · Jan 28, 2026 · [Details](RDa6WtZmW8E.md) (shared: `zero-cost abstractions` · `zero-cost` · `abstractions`)
...
- [Building the Multimodal Al Lakehouse](https://youtu.be/n9Ebc-0E478) — Development · 20 views · May 14, 2026 · [Details](n9Ebc-0E478.md) (shared: `interop` · `table` · `api`)
