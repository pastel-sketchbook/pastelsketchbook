...
- [ZAP: Getting Started with Software Security Testing](https://youtu.be/infh5ZZwvLU) — Security · 19 views · Apr 30, 2026 · [Details](infh5ZZwvLU.md) (shared: `security` · `defense in depth` · `defense`)
