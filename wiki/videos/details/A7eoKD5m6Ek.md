...
- [Secure Web App with Azure AD/OAuth2 Proxy](https://youtu.be/rgY4KTMFOMs) — Kubernetes · 46 views · Feb 5, 2026 · [Details](rgY4KTMFOMs.md) (shared: `aks security` · `aks` · `security`)
...
- [Architecting AKS Node Auto-Provisioning](https://youtu.be/3hSdKvqPcSE) — Kubernetes · 35 views · Feb 25, 2026 · [Details](3hSdKvqPcSE.md) (shared: `aks` · `cluster`)
