...
- [Cloth Simulation ](https://youtu.be/3Fpey_L_XRU) — Development · 13 views · Jan 25, 2026 · [Details](3Fpey_L_XRU.md) (shared: `integration` · `verlet integration` · `verlet`)
...
- [The Axum Web Framework](https://youtu.be/J4iGUAXcAOA) — Development · 18 views · May 1, 2026 · [Details](J4iGUAXcAOA.md) (shared: `rust` · `integration`)
