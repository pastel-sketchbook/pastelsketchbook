...
- [The Road to SolidJS 2.0](https://youtu.be/00kCzR10M1w) — Development · 305 views · Mar 3, 2026 · [Details](00kCzR10M1w.md) (shared: `signals` · `batching` · `reactivity`)
...
- [The Universal Engine for LLM Inference](https://youtu.be/OKXt-PJUuzE) — Development · 85 views · Jun 21, 2026 · [Details](OKXt-PJUuzE.md) (shared: `batching` · `compute`)
