...
- [microgpt-zig: Atomic Al Training](https://youtu.be/AcpVuvtSXwI) — Development · 59 views · Feb 28, 2026 · [Details](AcpVuvtSXwI.md) (shared: `zig` · `gpt` · `architecture`)
...
- [Architecting the Autonomous Enterprise](https://youtu.be/YoIXlqspLWE) — Development · 24 views · Apr 2, 2026 · [Details](YoIXlqspLWE.md) (shared: `autonomous` · `automation` · `architecture`)
- [The Complete Guide to Building Skills for Claude](https://youtu.be/JeqaHMmSh1s) — Development · 716 views · Feb 27, 2026 · [Details](JeqaHMmSh1s.md) (shared: `automation` · `model` · `optimization`)
