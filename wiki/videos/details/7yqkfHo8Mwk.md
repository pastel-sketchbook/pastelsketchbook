...
- [The Complete Guide to Building Skills for Claude](https://youtu.be/JeqaHMmSh1s) — Development · 724 views · Feb 27, 2026 · [Details](JeqaHMmSh1s.md) (shared: `automation` · `model` · `optimization`)
