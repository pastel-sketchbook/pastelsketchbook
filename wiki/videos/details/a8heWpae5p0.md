...
- [From Consensus Physics to Messaging Engineering](https://youtu.be/V9tvg6Yg3m4) — Kubernetes · 45 views · May 7, 2026 · [Details](V9tvg6Yg3m4.md) (shared: `raft` · `consensus` · `distributed`)
...
- [BadgerDB: The Go-Native Key-Value Store](https://youtu.be/eI2DXGISpbk) — Kubernetes · 57 views · Feb 12, 2026 · [Details](eI2DXGISpbk.md) (shared: `key-value` · `store`)
