...
- [Architecting Scalable Rust Backends](https://youtu.be/SpNfrWmI8iE) — Development · 72 views · Feb 22, 2026 · [Details](SpNfrWmI8iE.md) (shared: `pattern` · `architecture` · `dependency injection`)
