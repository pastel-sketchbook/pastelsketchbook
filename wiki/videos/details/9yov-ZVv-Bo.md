...
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 70 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `engineering` · `performance`)
...
- [The Anatomy of Modern Text](https://youtu.be/bAoDvQgmGjM) — Development · 47 views · May 17, 2026 · [Details](bAoDvQgmGjM.md) (shared: `processing` · `unicode`)
