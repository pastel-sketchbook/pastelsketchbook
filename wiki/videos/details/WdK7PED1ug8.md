...
- [The End of the Functional Programming Tax](https://youtu.be/240fOdSvnpk) — Development · 22 views · Jun 14, 2026 · [Details](240fOdSvnpk.md) (shared: `reference` · `counting` · `concurrency`)
