...
- [Agentic Platform Engineering with GitHub Copilot](https://youtu.be/lexZnOlyml0) — Kubernetes · 68 views · Mar 26, 2026 · [Details](lexZnOlyml0.md) (shared: `platform` · `engineering`)
