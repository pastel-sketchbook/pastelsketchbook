...
- [Burn: The Rust Deep Learning Framework](https://youtu.be/joYJ6rPN3UI) — Development · 677 views · Feb 13, 2026 · [Details](joYJ6rPN3UI.md) (shared: `rust` · `code` · `generation`)
- [Zig  Pragmatic Successor to C](https://youtu.be/yOOQNnaOLeM) — Development · 26 views · Jan 9, 2026 · [Details](yOOQNnaOLeM.md) (shared: `rust` · `programming` · `macros`)
