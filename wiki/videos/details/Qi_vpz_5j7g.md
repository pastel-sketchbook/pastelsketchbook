...
- [Candle: A Minimalist Framework for Serverless ML Inference](https://youtu.be/8PaVKQoDReY) — Development · 110 views · May 9, 2026 · [Details](8PaVKQoDReY.md) (shared: `onnx` · `graph` · `inference`)
...
- [Deconstructing Elixir's 400x Type System Acceleration](https://youtu.be/gVZwfZVAuVE) — Development · 45 views · Mar 4, 2026 · [Details](gVZwfZVAuVE.md) (shared: `form` · `type` · `inference`)
