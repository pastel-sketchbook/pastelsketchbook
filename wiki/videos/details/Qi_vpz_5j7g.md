...
- [OpenCV Library Architecture and Capabilities](https://youtu.be/ZfAc2pqcS-4) — Development · 47 views · May 11, 2026 · [Details](ZfAc2pqcS-4.md) (shared: `graph` · `inference` · `api`)
- [Candle: A Minimalist Framework for Serverless ML Inference](https://youtu.be/8PaVKQoDReY) — Development · 63 views · May 9, 2026 · [Details](8PaVKQoDReY.md) (shared: `onnx` · `graph` · `inference`)
- [Burn: The Rust Deep Learning Framework](https://youtu.be/_bFOZ51Q55Y) — Development · 1.7K views · May 8, 2026 · [Details](_bFOZ51Q55Y.md) (shared: `adapters` · `backend` · `hardware`)
...
- [The Burn Book](https://youtu.be/B7MMdnv3y1M) — Development · 28 views · May 21, 2026 · [Details](B7MMdnv3y1M.md) (shared: `onnx` · `inference` · `hardware`)
