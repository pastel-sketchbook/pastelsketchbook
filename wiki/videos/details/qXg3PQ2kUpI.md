...
- [The Internal Developer Platform Blueprint](https://youtu.be/iJnsRUJonzw) — Kubernetes · 78 views · Jul 25, 2026 · [Details](iJnsRUJonzw.md) (shared: `backstage developer portal` · `backstage` · `developer`)
- [Architecting LLM Inference at Scale](https://youtu.be/WI8yUaPon0w) — Kubernetes · 23 views · Jul 31, 2026 · [Details](WI8yUaPon0w.md) (shared: `model` · `pipeline`)
...
- [Bridging the Mainframe to the Cloud](https://youtu.be/7iWL5-0C66s) — Kubernetes · 27 views · Apr 4, 2026 · [Details](7iWL5-0C66s.md) (shared: `pipeline`)
