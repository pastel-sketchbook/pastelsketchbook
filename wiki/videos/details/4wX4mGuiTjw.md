...
- [Practical Data Oriented Design in Zig](https://youtu.be/o9yaniXkM-0) — Development · 92 views · Jan 29, 2026 · [Details](o9yaniXkM-0.md) (shared: `zig` · `optimization` · `cache`)
- [The Confluent Systems Master Plan](https://youtu.be/J6dRkXZhnIQ) — Development · 70 views · Jul 9, 2026 · [Details](J6dRkXZhnIQ.md) (shared: `optimization` · `cache` · `learning`)
