...
- [Azure Linux 4.0 and the Al-Native Cloud Era](https://youtu.be/o9x4daXS4Rk) — Kubernetes · 28 views · Jul 5, 2026 · [Details](o9x4daXS4Rk.md) (shared: `azure` · `management` · `agentic`)
...
- [K8s Services  AKS & Istio](https://youtu.be/C5HqbzLRYZ0) — Kubernetes · 24 views · Jan 10, 2026 · [Details](C5HqbzLRYZ0.md) (shared: `management` · `aks`)
