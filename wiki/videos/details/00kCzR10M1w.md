...
- [Migrating to SolidJS 2.0](https://youtu.be/L4YBdUVCFd4) — Development · 299 views · May 30, 2026 · [Details](L4YBdUVCFd4.md) (shared: `reactivity` · `signals` · `stores`)
- [Clean Architecture in Angular](https://youtu.be/RJGNh8L-8rw) — Development · 55 views · Jun 23, 2026 · [Details](RJGNh8L-8rw.md) (shared: `signals` · `pattern` · `immutable`)
- [Modern State Architecture: The Repository Pattern](https://youtu.be/3ybGkjogcFQ) — Development · 42 views · Feb 20, 2026 · [Details](3ybGkjogcFQ.md) (shared: `signals` · `pattern`)
