...
- [Migrating to SolidJS 2.0](https://youtu.be/L4YBdUVCFd4) — Development · 111 views · May 30, 2026 · [Details](L4YBdUVCFd4.md) (shared: `reactivity` · `signals` · `stores`)
- [Clean Architecture in Angular](https://youtu.be/RJGNh8L-8rw) — Development · 47 views · Jun 23, 2026 · [Details](RJGNh8L-8rw.md) (shared: `signals` · `pattern` · `immutable`)
