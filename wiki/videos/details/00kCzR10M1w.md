...
- [Modern State Architecture: The Repository Pattern](https://youtu.be/3ybGkjogcFQ) — Development · 34 views · Feb 20, 2026 · [Details](3ybGkjogcFQ.md) (shared: `signals` · `pattern`)
...
- [Architecting Scalable Rust Backends](https://youtu.be/SpNfrWmI8iE) — Development · 71 views · Feb 22, 2026 · [Details](SpNfrWmI8iE.md) (shared: `async` · `pattern`)
- [The Blueprint of Reactivity](https://youtu.be/Gy-ky1pAF0U) — Development · 24 views · May 16, 2026 · [Details](Gy-ky1pAF0U.md) (shared: `async` · `graph`)
