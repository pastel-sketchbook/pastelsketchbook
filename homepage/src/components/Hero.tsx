        ...
        <section id="hero" className="min-h-screen flex flex-col items-center justify-center pt-24 px-6 text-center relative overflow-hidden">
            ...
            >
                <motion.h1
                    ...
                    className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl mb-8 text-[#1B3022] tracking-tighter leading-none"
                >
                    Pastel Sketchbook
                </motion.h1>
                ...
                >
                    <div className="absolute inset-0 bg-[#D4A373]/5 rounded-full blur-3xl -z-10"></div>
                ...
                <motion.p
                    ...
                    className="text-2xl md:text-4xl font-serif text-[#1B3022]/80 max-w-2xl mx-auto italic leading-relaxed"
                >
