        ...
        <mod.AreaChart width={width} height={height} data={data}>
            <defs>
                <linearGradient id="colorValue" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="hsl(var(--s))" stopOpacity={0.1} />
            ...
            <section id="investment" className="py-32 px-6 bg-pastel-bg" ref={investmentRef}>
                ...
                >
                    <div className="flex justify-center order-2 md:order-1">
                        ...
                        >
                            <svg className="w-full h-full text-pastel-dark/20" viewBox="0 0 100 120" fill="none">
                                ...
                                <path d="M11 85C11 85 30 75 50 80C70 85 89 80 89 80C89 95 85 108 50 108C15 108 11 95 11 80" fill="hsl(var(--p))" fillOpacity="0.05" />
                                <path d="M50 105V70" stroke="hsl(var(--n))" strokeWidth="1" strokeLinecap="round" />
                                <path d="M50 75C50 75 65 60 70 65C75 70 60 85 50 80" fill="hsl(var(--p))" fillOpacity="0.1" stroke="hsl(var(--n))" strokeWidth="0.5" />
                                <path d="M50 85C50 85 35 70 30 75C25 80 40 95 50 90" fill="hsl(var(--p))" fillOpacity="0.1" stroke="hsl(var(--n))" strokeWidth="0.5" />
                                <text x="50" y="98" textAnchor="middle" fontSize="3" fill="hsl(var(--n))" fontWeight="bold" className="uppercase tracking-widest opacity-40">COMMUNITY ETF FUND</text>
                            </svg>
                            <div className="absolute top-1/2 -left-20 animate-pulse opacity-20">
                                <svg className="w-40 h-20 text-pastel-tan" viewBox="0 0 100 50">
                    ...
                    <div className="order-1 md:order-2">
                        <h2 className="text-5xl md:text-6xl mb-10 leading-tight text-pastel-dark font-serif">We don't just earn.<br /><span className="italic">We invest.</span></h2>
                        <div className="space-y-8 text-pastel-dark/60 text-xl font-serif leading-relaxed italic">
                            <p>
                            ...
                            <p className="font-bold text-pastel-dark not-italic border-l-4 border-pastel-medium/30 pl-6 py-2 bg-pastel-medium/5">
            ...
            <section id="growth" className="py-32 px-6 bg-pastel-bg">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-24">
                        ...
                        <p className="text-pastel-dark/40 text-2xl font-serif italic">How Small Streams Become a River</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 items-center">
                        <SketchBox ref={chartRef} className="lg:col-span-2 bg-white p-4 sm:p-10 h-[300px] sm:h-[450px] min-h-[300px] relative shadow-sm overflow-hidden">
                            {hasDimensions ? (
                                ...
                                >
                                    <Suspense fallback={<div className="w-full h-full flex items-center justify-center"><div className="w-16 h-16 rounded-full border-2 border-pastel-dark/5 shimmer"></div></div>}>
                                        <Recharts
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <div className="w-16 h-16 rounded-full border-2 border-pastel-dark/5 shimmer"></div>
                                </div>
                            )}
                        </SketchBox>
                        ...
                        >
                            <SketchBox className="p-8 bg-white shadow-sm">
                                <h4 className="font-bold text-pastel-dark mb-6 uppercase tracking-widest text-xs">Model Assumptions</h4>
                                <ul className="text-sm space-y-4 text-pastel-dark/60 font-serif italic">
                                    <li className="flex justify-between border-b border-pastel-dark/5 pb-2"><span>Initial Seed:</span> <span className="font-bold not-italic text-pastel-dark">$1,000</span></li>
                                    <li className="flex justify-between border-b border-pastel-dark/5 pb-2"><span>Monthly Contribution:</span> <span className="font-bold not-italic text-pastel-dark">$200</span></li>
                                    <li className="flex justify-between"><span>Avg. Annual Return:</span> <span className="font-bold not-italic text-pastel-dark">7%</span></li>
                                </ul>
                                <p className="mt-8 text-[10px] uppercase tracking-wider text-pastel-dark/30 font-bold">Hypothetical illustration only.</p>
                            </SketchBox>
                            <p className="text-pastel-dark/50 italic leading-relaxed font-serif text-lg">
